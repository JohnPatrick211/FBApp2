...
<!-- Add Service -->
  <!--Confirm Modal-->
  <div class="modal fade" id="ForumDeleteModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="DeleteForum/{{$forums->forum_id}}" method="POST" enctype="multipart/form-data">
        ...
        {{ method_field('PATCH') }}
            ...
            <label class="col-form-label">Are you sure you want to delete this forum?</label>
