<div class="modal fade" id="EditForumModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <form action="EditForum/{{ $forums->forum_id }}" method="post" enctype="multipart/form-data">
              ...
              {{ method_field('PATCH') }}
                ...
                <input type="hidden" name="forum_id" id="forum_id" value="{{ $forums->forum_id }}">

                <div class="col-md-12">
                    <label class="col-form-label">Title</label>
                    <input type="text" class="form-control" name="edittitle" id="edittitle" value ="{{$forums->title}}" required>
                    <span class="text-danger" id="brancherror"></span>
                  </div>

                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <label class="col-form-label">Body</label>
                    <textarea name="editbody" rows="10" cols="30" class="form-control" required >{{$forums->body}}</textarea>
                  </div>
          </div>
          <br><br>
