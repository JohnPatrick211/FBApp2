...
Route::post('verifytenant/reject/{id}', [App\Http\Controllers\TenantApprovalCtr::class, 'reject']);
//MAINTENANCE
// User Maintenance
...
//Floor Maintenance
Route::get('floor-maintenance',[App\Http\Controllers\FloorMaintenanceCtr::class, 'index'])->middleware('Islogged');
Route::get('floor-maintenance/floor',[App\Http\Controllers\FloorMaintenanceCtr::class, 'floormaintenance_floor'])->middleware('Islogged');
Route::get('floor-maintenance-details/{id}',[App\Http\Controllers\FloorMaintenanceCtr::class, 'getFloorDetails'])->middleware('Islogged');
Route::post('floor/editfloor', [App\Http\Controllers\FloorMaintenanceCtr::class, 'updateFloor'])->middleware('Islogged');
Route::post('floor-maintenance/archivefloor/{id}', [App\Http\Controllers\FloorMaintenanceCtr::class, 'ArchiveFloor']);
Route::post('AddFloor', [App\Http\Controllers\FloorMaintenanceCtr::class, 'AddFloor']);
//Rule Maintenance
...
//Sales Reports
Route::get('tenant-reports',[App\Http\Controllers\SchedulePaymentCtr::class, 'index'])->middleware('Islogged');
Route::get('tenant-report-data',[App\Http\Controllers\SchedulePaymentCtr::class, 'TenantReportData'])->middleware('Islogged');
//FORUMS AND COMMENTS;
